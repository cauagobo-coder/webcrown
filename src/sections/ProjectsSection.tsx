            ...
            <AnimatePresence>
                {hoveredItem && (
                    <motion.div
                        ...
                        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-12 w-64 md:w-72 aspect-[4/5] rounded-xl overflow-hidden border border-brand-gold/30 shadow-[0_10px_40px_-10px_rgba(245,138,7,0.4)] z-[100] bg-[#080808] pointer-events-none"
                    >
